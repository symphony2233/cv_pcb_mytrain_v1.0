...
os.environ["WANDB_API_KEY"] = 'f97e631a010e510d97c3d717038a18e5825d9594'  # 将引号内的+替换成自己在wandb上的一串值
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'G:\\learin_data_02\\PCB_csdn01\\训练文件\\yolov5s\\weights/best.pt', help='initial weights path')
